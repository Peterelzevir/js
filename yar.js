...
const bot = new Telegraf('7416992564:AAEqFLUnVnKiRm8mNwbW_jbUwQ_voNPRfL4');
const adminId = '5803301313';  // Ganti dengan ID admin bot
...
const sendNoAccessMessage = (ctx) => {
  ...
  const message = `🖐🏻 Halo @${username} Saya adalah Bot Convert File By [YARR](https://t.me/yrws1110)\n\nUntuk dapat akses fitur bot silahkan hubungi @yrws1110`;
  ctx.replyWithMarkdown(message, {
    reply_markup: {
      inline_keyboard: [
        [{ text: 'Order Sewa Bot 💡', url: 'https://t.me/yrws1110' }]
      ]
    }
  });
};
